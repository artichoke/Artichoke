...
const EXCEPTION_CSTR: &CStr = c"Exception";
const NO_MEMORY_CSTR: &CStr = c"NoMemoryError";
const SCRIPT_CSTR: &CStr = c"ScriptError";
const LOAD_CSTR: &CStr = c"LoadError";
const NOT_IMPLEMENTED_CSTR: &CStr = c"NotImplementedError";
const SYNTAX_CSTR: &CStr = c"SyntaxError";
const SECURITY_CSTR: &CStr = c"SecurityError";
const SIGNAL_CSTR: &CStr = c"SignalException";
const INTERRUPT_CSTR: &CStr = c"Interrupt";
const STANDARD_CSTR: &CStr = c"StandardError";
const ARGUMENT_CSTR: &CStr = c"ArgumentError";
const UNCAUGHT_THROW_CSTR: &CStr = c"UncaughtThrowError";
const ENCODING_CSTR: &CStr = c"EncodingError";
const FIBER_CSTR: &CStr = c"FiberError";
const IO_CSTR: &CStr = c"IOError";
const EOF_CSTR: &CStr = c"EOFError";
const INDEX_CSTR: &CStr = c"IndexError";
const KEY_CSTR: &CStr = c"KeyError";
const STOP_ITERATION_CSTR: &CStr = c"StopIteration";
const LOCAL_JUMP_CSTR: &CStr = c"LocalJumpError";
const NAME_CSTR: &CStr = c"NameError";
const NO_METHOD_CSTR: &CStr = c"NoMethodError";
const RANGE_CSTR: &CStr = c"RangeError";
const FLOAT_DOMAIN_CSTR: &CStr = c"FloatDomainError";
const REGEXP_CSTR: &CStr = c"RegexpError";
const RUNTIME_CSTR: &CStr = c"RuntimeError";
const FROZEN_CSTR: &CStr = c"FrozenError";
const SYSTEM_CALL_CSTR: &CStr = c"SystemCallError";
const THREAD_CSTR: &CStr = c"ThreadError";
const TYPE_CSTR: &CStr = c"TypeError";
const ZERO_DIVISION_CSTR: &CStr = c"ZeroDivisionError";
const SYSTEM_EXIT_CSTR: &CStr = c"SystemExit";
const SYSTEM_STACK_CSTR: &CStr = c"SystemStackError";
const FATAL_CSTR: &CStr = c"fatal";
